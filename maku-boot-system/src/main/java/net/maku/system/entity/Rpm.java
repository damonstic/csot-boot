...
@Data
@TableName("robo_rpm_max_min")
public class Rpm {@TableId(type = IdType.AUTO)
private Integer id;
    @TableField("robotsn")
    ...
    public Rpm(Integer id, String robotsn, String factory_end, String factory_type, String robotsn_type, Double speed1_max, Double speed1_min, Double speed2_max, Double speed2_min, Double speed3_max, Double speed3_min, Double speed4_max, Double speed4_min, Double speed5_max, Double speed5_min, Double speed6_max, Double speed6_min, Double speed7_max, Double speed7_min, Double speed8_max, Double speed8_min) {
        this.id = id;
    ...
    public Rpm(String robotsn, Double speed1_max, Double speed1_min, Double speed2_max, Double speed2_min, Double speed3_max, Double speed3_min, Double speed4_max, Double speed4_min, Double speed5_max, Double speed5_min, Double speed6_max, Double speed6_min, Double speed7_max, Double speed7_min, Double speed8_max, Double speed8_min) {
    }
